...
Problem:
   ...
   If the ball were to continue bouncing, the distance after two bounces would be 10ft6 ft 6ft3 .6ft 25.6f t111 5 .
   Note that the distance traveled for each successive bounce is the distance to the floor plus 0.6 of that distance as
   the ball comes back up. Write a program that lets the user enter the initial height from which the ball  is dropped
   and the number of times the ball is allowed to continue bouncing.
